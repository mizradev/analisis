...
//$lquery = mysqli_query($conexion,$consultar);
    ...
    if (!empty($_SESSION['active'] )) //si existe esta sesion 
    {
        $r=$_SESSION['Nombre'];
            ...
            $consultar= "SELECT Usuarios.Cod_Usuario, Usuarios.Nom_Usuario, Usuarios.Tip_Rol, Usuarios.Pas_Usuario,
              Personas.Nom_Persona, Personas.Ape_Persona,
               Estudiantes.Num_Cuenta, Estudiantes.Car_Estudiante,
              ...
              JOIN Correos
                   ...
                   $general = mysqli_query($conexion,$consultar);
    }
