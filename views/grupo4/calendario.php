            ...
            <div class="col-xs-12 col-md-4 col-lg-4 col-xl-3">
                <div class="card-box tilebox-one noradius">
                    <div id='external-events'>
                        ...
                        <p>Arrastra y suelta tu eveno en el calendario</p>
                        <div class='fc-event bg-primary'>Nueva Reunión</div>
                        <div class='fc-event bg-warning'>Mi Evento 2</div>
                        <div class='fc-event bg-danger'>Mi Evento 3</div>
                        <div class='fc-event bg-primary'>Reunión 2</div>
                        <div class='fc-event bg-info'>Tarea Numero 2</div>
                        <p>
