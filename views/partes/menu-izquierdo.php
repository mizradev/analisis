        ...
        <div class="user-profile position-relative" style="
            ...
            <div class="profile-text pt-1">
                <a href="#" class="dropdown-toggle u-dropdown w-100 text-white d-block" data-toggle="dropdown"
                    role="button" aria-haspopup="true" aria-expanded="true">UNAH, <?php  echo fechaC();?></a>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="estudiantes.php"
                        aria-expanded="false">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="grupo4/histor.php" class="sidebar-link">
                                <i class="mdi mdi-adjust"></i>
